    ...
    <Page className="home-page">
      <Box className="content">
              ...
              <SvgIcon sx={{ width: "5vh", height: "5vh" }}>
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M17 8C16.5858 8 16.25 8.33579 16.25 8.75V16.25H8.75C8.33579 16.25 8 16.5858 8 17C8 17.4142 8.33579 17.75 8.75 17.75H16.25V25.25C16.25 25.6642 16.5858 26 17 26C17.4142 26 17.75 25.6642 17.75 25.25V17.75H25.25C25.6642 17.75 26 17.4142 26 17C26 16.5858 25.6642 16.25 25.25 16.25H17.75V8.75C17.75 8.33579 17.4142 8 17 8Z"
                    fill="white"
                  />
                </svg>
              </SvgIcon>
        ...
        {value === 0 ? (
          ...
          <Box>
            <Text.Title>under development</Text.Title>
          </Box>
        )}
      </Box>
